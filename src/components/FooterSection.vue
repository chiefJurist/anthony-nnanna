            ...
            <div class="grid md:grid-cols-3 gap-10 items-center">
                ...
                <div class="text-center md:text-left">
                    ...
                    <p class="mt-2 text-gray-600 dark:text-gray-400">
                        Senior Full-Stack Engineer<br />Laravel · PHP · JavaScript · TypeScript ·
                        Node.js · Vue · React · Python
                    </p>
                </div>

                <!-- Center: Quick Links -->
                <div class="flex justify-between items-center flex-wrap text-sm font-medium">
                    <a
                        href="#hero"
